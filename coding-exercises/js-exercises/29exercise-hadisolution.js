...
//1.  Create a function will calculate how many times empty space occurred in a given string by 
// the user and print out only the characters number
...
const emptySpaces = str => {
  ...
  // 3. Create a function that receive a text from user and check if the user has entered a phone number, and print that out
